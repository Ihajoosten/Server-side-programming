...
namespace Client.Extentsions.Dish
{
    public static class DishMethods
    {
        ...
        public static async Task<JArray> GetDishes()
        {
            // Define your baseUrl
            ...
            try
            {
                ...
                {
                    // In the next using statement you will initiate the Get Request, use the await keyword so 
                    // it will execute the using statement in order.
                    // The HttpResponseMessage which contains status code, and data from response.
                    using (HttpResponseMessage res = await client.GetAsync(baseUrl))
                    {
                        // Then get the data or content from the response in the next using statement, 
                        // then within it you will get the data, and convert it to a c# object.
        ...
        public static async Task<JObject> GetDishById(this int id)
        {
            // Define your baseUrl with index
            string baseUrl = $"https://easy-meal-sswp-api.azurewebsites.net/api/Dish/{id}";
